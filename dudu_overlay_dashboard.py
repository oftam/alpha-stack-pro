...
try:
    ...
    # Render projection
    render_projection_tab(st, df, qc_payload=None, horizon=horizon, key="dudu_standalone_live")
    ...
    render_projection_tab(st, df, qc_payload=None, horizon=48, key="dudu_standalone_demo")
