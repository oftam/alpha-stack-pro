@echo off
REM ============================================================
REM ALPHA STACK PRO - Quick Start (All-in-One) - ANACONDA FIX
REM ============================================================
...
echo.
echo ============================================================
echo ALPHA STACK PRO - QUICK START (ANACONDA FIX)
echo ============================================================
echo.
echo This will:
...
if not exist "alpha_stack_backtest.py" (
    ...
    echo Make sure you're in the correct folder with all files.
    pause
    exit /b 1
)
...
if !errorlevel! neq 0 (
    ...
    echo Try running Anaconda Prompt instead:
    echo   1. Open Anaconda Prompt
    echo   2. Type: cd Documents\alpha-stack-pro
    echo   3. Type: python -m pip install -r requirements.txt
    pause
    exit /b 1
)
